...
function llenarMensaje(nombreUsuario, fecha, mensaje){
    const h3 = document.querySelector('#messageContainer > h3')
    h3.textContent = nombreUsuario
    const h4 = document.querySelector('#messageContainer > h4')
    h3.textContent = fecha
    const p = document.querySelector('#messageContainer > p')
    h3.textContent = mensaje

}

llenarMensaje('Raysell Concepcion', '25/07/1999', 'Es mi cumpleaño')